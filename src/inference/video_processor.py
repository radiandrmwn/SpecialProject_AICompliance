...
def process_video_for_violations(
    ...
    sample_rate: int = 2,  # Process every Nth frame for speed
    ...
    Args:
        ...
        sample_rate: Process every Nth frame (1=all frames, 2=every 2nd frame)
            ...
            try:
                ...
                if person_results[0].boxes is not None:
                    for box in person_results[0].boxes:
                        ...
                        # Violation if missing BOTH helmet AND vest
                        is_violator = not has_helmet and not has_vest
